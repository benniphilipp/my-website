...
from .views import CustomerListView, LoadCustomerFormView, CustomerUpdateAjaxView, LoadCampaignFormView, SaveCampaignView, CustomerCreateAjaxView, customer_update_ajax
